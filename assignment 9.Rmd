...
C)it can't be done in one line
...
####1. Suppose you want to make an MA plot of the first two samples 
```{r}
y= geneExpression[,1:2]
``` 
####Which of the following projections gives us the projection of y so that column2 versus column 1 is an MA plot?
Answer: B
